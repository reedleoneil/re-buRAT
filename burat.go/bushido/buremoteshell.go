...
func (b *buRemoteShell) RemoteShells() []remoteshell.RemoteShell {
	return b.remoteShells
}

func (b *buRemoteShell) OnOpen(handler func (id string)) {
  b.onOpen = handler
}

func (b *buRemoteShell) OnClose(handler func (id string)) {
  b.onClose = handler
}

func (b *buRemoteShell) OnRead(handler func (id string, data string)) {
  b.onRead= handler
}

func (b *buRemoteShell) OnWrite(handler func (id string, data string)) {
  b.onWrite = handler
}

func (b *buRemoteShell) OnError(handler func (id string, error string)) {
  b.onError = handler
}
...
func (b *buRemoteShell) Close(id string) {
  ...
  b.remoteShells = append(b.remoteShells[:x], b.remoteShells[x+1:]...)
}
